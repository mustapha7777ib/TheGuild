  ...
  const fetchAdminData = useCallback(async () => {
    ...
    try {
      ...
      const responses = await Promise.all(
        endpoints.map(ep => fetch(`/api/admin/${ep}`, { credentials: "include" }))
      );
      ...
      const trendsRes = await fetch(`/api/admin/signup-trends?range=${timeRange}&role=${roleFilter}`, { credentials: "include" });
